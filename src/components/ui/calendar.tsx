  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-bold text-primary px-8",
        nav: "flex items-center",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-8 w-8 bg-primary/5 p-0 opacity-70 hover:opacity-100 border-none rounded-xl transition-all hover:bg-primary hover:text-white"
        ),
        ...
        day: cn(
          ...
          "h-10 w-10 p-0 font-medium aria-selected:opacity-100 rounded-xl transition-all"
        ),
        ...
        day_today: "bg-secondary/40 text-primary font-bold",
        day_outside:
